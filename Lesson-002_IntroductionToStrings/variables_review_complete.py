...
user_profression = "Pianist"

user_profression = "Assasin"
...
print(user_location)
print(user_profression)

print(username, user_location, user_profression)
...
my_favorite_food = "cake"

my_favorite_movie = "Star Wars"

print("My name is:",my_name,"My Favorite Food:", my_favorite_food, "My Favorite Movie:", my_favorite_movie)
